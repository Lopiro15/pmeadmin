...
#[ApiResource(
    ...
    normalizationContext: ['groups' => 'read:banniereSponsor']
)]
#[ORM\Entity(repositoryClass: BanniereSponsorRepository::class)]
#[ORM\HasLifecycleCallbacks]
#[Vich\Uploadable]
class BanniereSponsor
{
