...
#[ApiResource(
    ...
    normalizationContext: ['groups' => 'read:banniereBilleterie']
)]
#[ORM\Entity(repositoryClass: BanniereBilleterieRepository::class)]
#[ORM\HasLifecycleCallbacks]
#[Vich\Uploadable]
class BanniereBilleterie
{
    ...
    #[Groups(['read:banniereBilleterie'])]
