...
#[ApiResource(
    ...
    normalizationContext: ['groups' => 'read:exposantBanniere']
)]
#[ORM\Entity(repositoryClass: BanniereExposantRepository::class)]
#[ORM\HasLifecycleCallbacks]
#[Vich\Uploadable]
class BanniereExposant
{
